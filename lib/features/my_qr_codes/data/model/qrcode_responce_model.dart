...
class QrcodeResponceModel {
    ...
    final List<QrcodeModel> data;

    QrcodeResponceModel copyWith({
        num? pageIndex,
        num? pageSize,
        num? count,
        num? pagesCount,
    ...
    factory QrcodeResponceModel.fromJson(Map<String, dynamic> json){ 
        return QrcodeResponceModel(
            ...
            data: json["data"] == null ? [] : List<QrcodeModel>.from(json["data"]!.map((x) => QrcodeModel.fromJson(x))),
        );
    }
